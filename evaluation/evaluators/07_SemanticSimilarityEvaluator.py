...
from utils.evaluation import load_embedding_model, load_llm, load_index
...
## Use Evaluator: no
## Result:
# score: 0.3063621593405556
# this test doesn't seem to be working as expected therefore this evaluator is not used